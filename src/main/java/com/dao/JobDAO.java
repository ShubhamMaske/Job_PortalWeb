...
public class JobDAO {
	...
	public List<Jobs> getJobOrLocationAndCategory(String category,String location){
		List<Jobs> list = new ArrayList<Jobs>();
		Jobs j=null;
		try {
	...
	public List<Jobs> getJobAndLocationAndCategory(String category,String location){
		List<Jobs> list = new ArrayList<Jobs>();
		Jobs j=null;
		try {
